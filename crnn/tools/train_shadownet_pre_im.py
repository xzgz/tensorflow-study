...
from local_utils import data_utils_pre, log_utils
from global_configuration import config_pre


config = config_pre
data_utils = data_utils_pre
# os.environ["CUDA_VISIBLE_DEVICES"] = "0"
beam_width = 10
num_classes = 4425
# num_classes = 1800
# num_classes = 2292
snapshot_path = '/home/weiying1/hyg/icpr/CRNN_Tensorflow/model/shadownet-pre-im'
tfboard_save_path = 'tboard/shadownet-pre-im'
model_save_dir = 'model/shadownet-pre-im'
tfrecord_dir = '/home/weiying1/hyg/data/icpr/tfrecords-pre'
# snapshot_path += '/shadownet_2018-05-05-08-03-54.ckpt-60000'
snapshot_path += '/shadownet_2018-05-05-21-33-39.ckpt-100000'
# snapshot_path = None
start_iter = 100000
...
def train_shadownet(dataset_dir, batch_size, seq_length, weights_path=None):
    ...
    inputdata, input_labels, input_imagenames = tf.train.shuffle_batch(
        ...
        capacity=19200,#57600,#2000,#
        min_after_dequeue=16000,#48000,#1600,#
        num_threads=1)
    ...
    decoded, log_prob = tf.nn.ctc_beam_search_decoder(net_out, seq_length*np.ones(batch_size),
                                                      beam_width=beam_width, merge_repeated=False)
...
#     sess_config = tf.ConfigProto(device_count = {'GPU': 0})
    ...
    with sess.as_default():
        ...
        for epoch in range(start_iter, train_epochs+1):
            ...
            if epoch % 15000 == 0 and epoch > 50000:
...
#     tf.reset_default_graph()
    train_shadownet(args.dataset_dir, batch_size=10*32, seq_length=25, weights_path=args.weights_path)
    print('Done')
